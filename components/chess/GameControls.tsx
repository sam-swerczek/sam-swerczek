    ...
    <div className="bg-background-secondary/50 backdrop-blur-sm border border-accent-blue/20 rounded-lg p-4">
      <div className="space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-accent-teal/10 hover:bg-accent-teal/20 border border-accent-teal/30 hover:border-accent-teal/50 text-accent-teal rounded-lg transition-all duration-300 font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-accent-teal/10 disabled:hover:border-accent-teal/30"
        >
